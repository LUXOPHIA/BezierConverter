...
type //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$【型】
     ...
     private
       ///// アクセス
       function GetXs( const X_:Integer ) :Byte; inline;
       procedure SetXs( const X_:Integer; const V_:Byte ); inline;
     public
       constructor Create( const V_:Byte ); overload;
       constructor Create( const X_,Y_:Byte ); overload;
       ///// プロパティ
       property Xs[ const X_:Integer ] :Byte read GetXs write SetXs; default;
     case Byte of
     ...
     private
       ///// アクセス
       function GetXs( const X_:Integer ) :Integer; inline;
       procedure SetXs( const X_:Integer; const V_:Integer ); inline;
     public
       ///// プロパティ
       property Xs[ const X_:Integer ] :Integer read GetXs write SetXs; default;
     case Byte of
     ...
     private
       ///// アクセス
       function GetXs( const X_:Byte ) :Int64u; inline;
       procedure SetXs( const X_:Byte; const V_:Int64u ); inline;
     public
       constructor Create( const V_:Int64u ); overload;
       constructor Create( const X_,Y_:Int64u ); overload;
       ///// プロパティ
       property Xs[ const X_:Byte ] :Int64u read GetXs write SetXs; default;
     case Byte of
     ...
     private
       ///// アクセス
       function GetXs( const X_:Integer ) :Int64s; inline;
       procedure SetXs( const X_:Integer; const V_:Int64s ); inline;
     public
       constructor Create( const V_:Int64s ); overload;
       constructor Create( const X_,Y_:Int64s ); overload;
       ///// プロパティ
       property Xs[ const X_:Integer ] :Int64s read GetXs write SetXs; default;
     case Byte of
     ...
     private
       ///// アクセス
       function GetXs( const X_:Integer ) :Single; inline;
       procedure SetXs( const X_:Integer; const V_:Single ); inline;
     ...
     public
       ...
       ///// プロパティ
       property Xs[ const X_:Integer ] :Single    read GetXs      write SetXs    ; default;
     ...
     private
       ///// アクセス
       function GetXs( const X_:Integer ) :Double; inline;
       procedure SetXs( const X_:Integer; const V_:Double ); inline;
     ...
     public
       ...
       ///// プロパティ
       property Xs[ const X_:Integer ] :Double    read GetXs      write SetXs    ; default;
     ...
     private
       ///// アクセス
       function GetXs( const X_:Integer ) :TdSingle; inline;
       procedure SetXs( const X_:Integer; const V_:TdSingle ); inline;
     ...
     public
       ...
       ///// プロパティ
       property Xs[ const X_:Integer ] :TdSingle   read GetXs     write SetXs    ; default;
     ...
     private
       ///// アクセス
       function GetXs( const X_:Integer ) :TdDouble; inline;
       procedure SetXs( const X_:Integer; const V_:TdDouble ); inline;
     ...
     public
       ...
       ///// プロパティ
       property Xs[ const X_:Integer ] :TdDouble   read GetXs     write SetXs    ; default;
...
function TByte2D.GetXs( const X_:Integer ) :Byte;
begin
     Result := _Xs[ X_ ];
end;

procedure TByte2D.SetXs( const X_:Integer; const V_:Byte );
begin
     _Xs[ X_ ] := V_;
end;
...
function TInteger2D.GetXs( const X_:Integer ) :Integer;
begin
     Result := _Xs[ X_ ];
end;

procedure TInteger2D.SetXs( const X_:Integer; const V_:Integer );
begin
     _Xs[ X_ ] := V_;
end;
...
function TInt64u2D.GetXs( const X_:Byte ) :Int64u;
begin
     Result := _Xs[ X_ ];
end;

procedure TInt64u2D.SetXs( const X_:Byte; const V_:Int64u );
begin
     _Xs[ X_ ] := V_;
end;
...
function TInt64s2D.GetXs( const X_:Integer ) :Int64s;
begin
     Result := _Xs[ X_ ];
end;

procedure TInt64s2D.SetXs( const X_:Integer; const V_:Int64s );
begin
     _Xs[ X_ ] := V_;
end;
...
function TSingle2D.GetXs( const X_:Integer ) :Single;
begin
     Result := _Xs[ X_ ];
end;

procedure TSingle2D.SetXs( const X_:Integer; const V_:Single );
begin
     _Xs[ X_ ] := V_;
end;
...
function TDouble2D.GetXs( const X_:Integer ) :Double;
begin
     Result := _Xs[ X_ ];
end;

procedure TDouble2D.SetXs( const X_:Integer; const V_:Double );
begin
     _Xs[ X_ ] := V_;
end;
...
function TdSingle2D.GetXs( const X_:Integer ) :TdSingle;
begin
     Result := _Xs[ X_ ];
end;

procedure TdSingle2D.SetXs( const X_:Integer; const V_:TdSingle );
begin
     _Xs[ X_ ] := V_;
end;
...
function TdDouble2D.GetXs( const X_:Integer ) :TdDouble;
begin
     Result := _Xs[ X_ ];
end;

procedure TdDouble2D.SetXs( const X_:Integer; const V_:TdDouble );
begin
     _Xs[ X_ ] := V_;
end;
